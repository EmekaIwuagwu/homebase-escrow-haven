...
const LandlordLogin = () => {
  ...
  const handleConnectWallet = async (walletType: string) => {
    ...
    // Will redirect to landlord dashboard via the useEffect above when connected
  };
      ...
      <div className="flex-1 container mx-auto px-4 pt-24 pb-12 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold">Landlord Portal</CardTitle>
            <CardDescription>Connect your wallet to manage your rental properties</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center text-sm text-gray-500">
            <p>You need to connect your wallet to access the landlord dashboard</p>
          </CardFooter>
        </Card>
      </div>
      <Footer />
